...
if __name__ == '__main__':
    ...
    info_fp = '../songs/{}/info.json'.format(args.song_dirname)
    midi_fp = '../songs/{}/song.mid'.format(args.song_dirname)
    backing_track_fps = glob.glob('../songs/{}/*.aac'.format(args.song_dirname))
