        ...
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            open_flap = function _open_flap() {
              ...
              setTimeout(zoom_message, flap_open_ms + envelope_move_ms); // do the puppet loading stuff once the envelope is gone
    ...
    return regeneratorRuntime.wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 19:
            animation_noise_texture = _context8.sent;
            //
...
function _init_audio() {
  _init_audio = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee9() {
    var audio_url, audio_el, buffer_interval, playing, playback_btn, big_btn_container, big_btn, mobile_replay, replay_btn, decoration_img, desktop_volume_slider, mobile_volume_slider, desktop_replay, desktop_play, play_img, pause_img, replay_img, control_play_img, blue_play_img, control_pause_img, control_replay_img, control_volume_on_img, control_volume_off_img, mobile_play_img, mobile_pause_img, mobile_replay_img, mobile_volume_on_img, mobile_volume_off_img, last_slider_val, card_play, card_pause, handle_click, handle_replay, play_audio, pause_audio, handle_audio_end;
        ...
        switch (_context9.prev = _context9.next) {
          case 0:
            handle_audio_end = function _handle_audio_end() {
              clearInterval(buffer_interval);
              big_btn.attr('src', replay_img);
              big_btn_container.fadeIn(500); // dont want two replay buttons
              //if (!wide_mode()) {
              //    mobile_replay.fadeIn(500);
              //}
            ...
            big_btn_container = $('#big-play-button-overlay');
            big_btn = $('#big-play-button');
            mobile_replay = $('#mobile-replay-button');
            replay_btn = $('#replay-control');
            decoration_img = $('#decoration-image');
            desktop_volume_slider = $('#desktop-volume-slider');
            mobile_volume_slider = $('#mobile-volume-slider');
...
function _create_puppet() {
  _create_puppet = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee10(img_url) {
    return regeneratorRuntime.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 13:
            _context10.t0 = img_url;

          case 14:
            img_url = _context10.t0;
          ...
          case 18:
            pet_image_texture = _context10.sent;
            pet_material.map = pet_image_texture;
            face_animation_shader.uniforms.petImage.value = pet_image_texture; // TODO which of these is actually necessary
...
function _load_mouth_mesh() {
  _load_mouth_mesh = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee11(scene, model_path) {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          case 0:
            ...
            return _context11.abrupt("return", mouth_gltf);
...
function _load_texture() {
  _load_texture = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee12(img_src) {
...
function _load_image() {
  _load_image = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee13(img_src) {
...
function _load_gltf() {
  _load_gltf = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee14(model_path) {
...
function _load_hlsl_text() {
  _load_hlsl_text = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee15(url) {
    var response, text;
...
function _load_shader_files() {
  _load_shader_files = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee16() {
    return regeneratorRuntime.wrap(function _callee16$(_context16) {
      while (1) {
        switch (_context16.prev = _context16.next) {
          ...
          case 3:
            face_animation_shader.fragmentShader = _context16.sent;
          ...
          case 7:
            face_animation_shader.vertexShader = _context16.sent;
          ...
          case 11:
            mouth_shader.fragmentShader = _context16.sent;
          ...
          case 15:
            mouth_shader.vertexShader = _context16.sent;
...
function _to_b() {
  _to_b = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee17(img_src) {
    var img;
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          ...
          case 2:
            ...
            return _context17.abrupt("return", image_canvas.toDataURL());
...
function _fade_spinner() {
  _fade_spinner = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee18(duration, opacity) {
...
function _fade_container() {
  _fade_container = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee19(duration, opacity) {
...
function _test() {
  _test = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee20(img_url) {
...
function _find_features() {
  _find_features = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee21(img_url) {
